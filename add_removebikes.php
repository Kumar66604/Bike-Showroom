...
<?php 
 ...
 if($_SERVER["REQUEST_METHOD"]=="POST"){
   ...
   $target = "images/".basename($image);
     ...
     $cmp_name = $_POST["company"];
     $type = $_POST["biketype"];
     $avail = $_POST["avail"];
     $bikeno = $_POST["bikeno"];
     $price = $_POST["price"];
     $description = $_POST["description"];
     $sql = "INSERT INTO `bikes`(`bike_photo`,`bike_no`,`type`,`bike_name`,`availability`,`company`,`price`,`description`) VALUES ('$image','$bikeno','$type','$bikename','$avail','$cmp_name','$price','$description')";
